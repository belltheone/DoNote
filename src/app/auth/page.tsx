...
export default function AuthPage() {
    ...
    // 소셜 로그인 처리
    const handleSocialLogin = async (provider: 'google' | 'github' | 'kakao' | 'apple' | 'naver') => {
                                ...
                                {authMode === 'social' ? (
                                    ...
                                    >
                                        ...
                                        <motion.button
                                            ...
                                            disabled={isLoading !== null}
                                            className="w-full py-4 px-6 bg-[#FEE500] rounded-xl text-[#191919] font-semibold flex items-center justify-center gap-3 hover:bg-[#FFEB3B] transition-all shadow-sm disabled:opacity-50"
                                            whileHover={{ scale: 1.02 }}
                                            whileTap={{ scale: 0.98 }}
                                        >
                                            {isLoading === 'kakao' ? (
                                                ...
                                                <>
                                                    <svg className="w-5 h-5" viewBox="0 0 24 24" fill="#191919"><path d="M12 3c5.799 0 10.5 3.664 10.5 8.185 0 4.52-4.701 8.184-10.5 8.184a13.5 13.5 0 01-1.727-.11l-4.408 2.883c-.501.265-.678.236-.472-.413l.892-3.678c-2.88-1.46-4.785-3.99-4.785-6.866C1.5 6.665 6.201 3 12 3z" /></svg>
                                                    <span>카카오로 시작하기</span>
                                                </>
                                            )}
                                        </motion.button>

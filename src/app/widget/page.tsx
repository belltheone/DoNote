...
export default function WidgetDemoPage() {
        ...
        <div className="min-h-screen bg-white py-12 px-6">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="grid md:grid-cols-2 gap-8 mb-12">
                    ...
                    >
                        <h3 className="text-lg font-bold text-[#333] mb-4">티켓 스타일</h3>
                        <div className="space-y-4 flex flex-col items-center">
                            {widgetLoaded ? (
                                ...
                                <div className="text-[#999]">위젯 로딩 중...</div>
                            )}
                        </div>
                    </motion.div>
                    ...
                    >
                        <h3 className="text-lg font-bold text-[#333] mb-4">버튼 스타일</h3>
                        <div className="space-y-4 flex flex-col items-center">
                            {widgetLoaded ? (
                                <>
                                    <div id="button-1"></div>
                    ...
                    >
                        <h3 className="text-lg font-bold text-[#333] mb-4">미니 스타일</h3>
                    ...
                    >
                        <h3 className="text-lg font-bold text-[#333] mb-4">블로그에서 보이는 모습</h3>
                        <div className="bg-white rounded-lg p-6 shadow-sm border">
                            <h4 className="text-xl font-bold mb-2">오늘의 개발 일지</h4>
                            <p className="text-sm text-[#666] mb-4">
                                오늘은 React Query를 사용한 서버 상태 관리에 대해 알아보았습니다.
                                캐싱 전략과 Optimistic Updates 패턴이 인상적이었네요...
                            </p>
                            <div className="border-t pt-4 mt-4 flex items-center justify-between">
                                <span className="text-sm text-[#999]">이 글이 도움이 되셨다면...</span>
                ...
                {/* 사용 방법 */}
                <motion.div
                    className="bg-[#FFFACD] rounded-xl p-8"
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ delay: 0.5 }}
                >
                    <h3 className="text-lg font-bold text-[#333] mb-4">💡 사용 방법</h3>

                    <div className="space-y-4">
                        <div>
                            <h4 className="font-medium text-[#333] mb-2">1. SDK 스크립트 추가</h4>
                        ...
                        <div>
                            <h4 className="font-medium text-[#333] mb-2">2. 위젯 컴포넌트 삽입</h4>
                            <pre className="bg-gray-900 text-green-400 p-4 rounded-lg text-sm overflow-x-auto">
                                {`<donote-widget 
  handle="your-handle" 
  style-type="ticket" 
  ...
  text="커피 한 잔 ☕">
                        ...
                        <div>
                            <h4 className="font-medium text-[#333] mb-2">3. 또는 JavaScript API 사용</h4>
                            <pre className="bg-gray-900 text-green-400 p-4 rounded-lg text-sm overflow-x-auto">
